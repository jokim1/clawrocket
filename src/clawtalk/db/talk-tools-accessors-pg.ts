...
export const BUILTIN_TALK_TOOLS: ReadonlyArray<BuiltinTalkToolDefinition> = [
  { id: 'saved_sources', family: 'saved_sources', displayName: 'Saved Sources', description: 'Read saved Talk sources.', requiresBinding: false, defaultGrant: true, mutatesExternalState: false, sortOrder: 10 },
  { id: 'attachments', family: 'attachments', displayName: 'Message Attachments', description: 'Read attached Talk files.', requiresBinding: false, defaultGrant: true, mutatesExternalState: false, sortOrder: 20 },
  { id: 'web_search', family: 'web', displayName: 'Web Search', description: 'Search the public web.', requiresBinding: false, defaultGrant: true, mutatesExternalState: false, sortOrder: 30 },
  { id: 'web_fetch', family: 'web', displayName: 'Web Fetch', description: 'Fetch public web pages.', requiresBinding: false, defaultGrant: true, mutatesExternalState: false, sortOrder: 40 },
  { id: 'gmail_read', family: 'gmail', displayName: 'Gmail Read', description: 'Search and read mailbox content.', requiresBinding: false, defaultGrant: false, mutatesExternalState: false, sortOrder: 50 },
  { id: 'gmail_send', family: 'gmail', displayName: 'Gmail Send', description: 'Draft and send email.', requiresBinding: false, defaultGrant: false, mutatesExternalState: true, sortOrder: 60 },
  { id: 'google_drive_search', family: 'google_drive', displayName: 'Google Drive Search', description: 'Search within bound Google Drive resources.', requiresBinding: true, defaultGrant: true, mutatesExternalState: false, sortOrder: 70 },
  { id: 'google_drive_read', family: 'google_drive', displayName: 'Google Drive Read', description: 'Read bound Google Drive files.', requiresBinding: true, defaultGrant: true, mutatesExternalState: false, sortOrder: 80 },
  { id: 'google_drive_list_folder', family: 'google_drive', displayName: 'Google Drive List Folder', description: 'List bound Google Drive folders.', requiresBinding: true, defaultGrant: true, mutatesExternalState: false, sortOrder: 90 },
  { id: 'google_docs_read', family: 'google_docs', displayName: 'Google Docs Read', description: 'Read bound Google Docs.', requiresBinding: true, defaultGrant: false, mutatesExternalState: false, sortOrder: 100 },
  { id: 'google_docs_batch_update', family: 'google_docs', displayName: 'Google Docs Update', description: 'Update bound Google Docs.', requiresBinding: true, defaultGrant: false, mutatesExternalState: true, sortOrder: 110 },
  { id: 'google_sheets_read_range', family: 'google_sheets', displayName: 'Google Sheets Read', description: 'Read bound Google Sheets.', requiresBinding: true, defaultGrant: false, mutatesExternalState: false, sortOrder: 120 },
  { id: 'google_sheets_batch_update', family: 'google_sheets', displayName: 'Google Sheets Update', description: 'Update bound Google Sheets.', requiresBinding: true, defaultGrant: false, mutatesExternalState: true, sortOrder: 130 },
  { id: 'data_connectors', family: 'data_connectors', displayName: 'Data Connectors', description: 'Use attached Talk data connectors.', requiresBinding: false, defaultGrant: true, mutatesExternalState: false, sortOrder: 140 },
];
...
export async function createGoogleOAuthLinkRequest(input: {
  ...
  if (!got) {
    throw new Error(
      'createGoogleOAuthLinkRequest: missing row after insert',
    );
  }
  return got;
}
